...
# Python Financial Data Analyzer: CSV Processing, Aggregation & Visualization
## Project Overview
...
2. Ensure you have the required libraries installed: `pip install pandas matplotlib`.
3. Run the script from your terminal: `python analyzer.py`.
